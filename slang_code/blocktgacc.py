...
receivers = ['sms@telegram.org', 'dmca@telegram.org', 'abuse@telegram.org',
             'sticker@telegram.org', 'support@telegram.org', 'topCA@telegram.org', 'recover@telegram.org',
             'ceo@telegram.org']


def logo():
    print("TG KILLER Upd byAnsorUz")


def menu():
    print("1. Снос акков.")
    print("2. Снос канала")
    print("3. Aвторы проекта AnsorUz")
    print("4. Снос бота.")
